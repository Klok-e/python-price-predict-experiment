...
from util import SKIP_STEPS, calculate_observation, full_preprocess


def create_backtest_model_with_data(rl_model, data: pd.DataFrame, scaler: MinMaxScaler, start, end):
    class NeuralNetStrat(Strategy):
        ...
        def next(self):
            ...
            if len(self.data) > SKIP_STEPS:
                ...
                preprocessed, _ = full_preprocess(df, scaler)
    ...
    backtest_dataset = data.iloc[start:]
